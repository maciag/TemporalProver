...
prover: main.cpp truthtrees/TruthTree.cpp truthtrees/FormulaNode.cpp truthtrees/StringFormula.cpp truthtrees/LexicalTable.cpp  lib/functions.a obj/GUI.o obj/WorkerThread.o
	...
	dmd -ofprover lib/functions.a obj/main.o obj/WorkerThread.o obj/moc_WorkerThread.o obj/TruthTree.o obj/FormulaNode.o obj/StringFormula.o obj/LexicalTable.o obj/GUI.o obj/moc_GUI.o -L-lstdc++ -L-lQt5Core -L-lQt5Gui -L-lQt5Quick -L-lQt5Qml -L-lQt5Widgets -L-lstdc++
	
obj/GUI.o : gui/GUI.cpp gui/GUI.hpp
	cd gui; qmake && make; cd ..
	rm lib/libGUI*
	
obj/WorkerThread.o : truthtrees/WorkerThread.cpp truthtrees/WorkerThread.hpp
	cd truthtrees; qmake && make; cd ..
	rm lib/libWorkerThread*
